...
def main():
    ...
    if len(args)==1:
        gradescope_response = {}
        gradescope_response['tests'] = []
        sumTotal= 0
        sumPossible = 0
        for q in questions:
            func = globals()[q+'Tests']
            total, possible = func()
            gradescope_response['tests'].append({
                'name': q,
                'score': total,
                'max_score': possible,
                'tags': []
        ...
        gradescope_response['score'] = sumTotal
        gradescope_response['max_score'] = sumPossible
        print('\nAutograder finished. Final score %d/%d'%(sumTotal,sumPossible))
        json.dump(gradescope_response, open('gradescope_response.json', 'w'))
    else:
